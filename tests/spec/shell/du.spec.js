...
describe('FileSystemShell.du', function() {
  ...
  it('should return the size of the files', function(done) {
    var fs = util.fs();
    var shell = fs.Shell();
    var contents = "a";
    var contents2 = "bb";
  ...
  it('should return the deep contents of a dir tree containing the sizes of each entry', function(done) {
    var fs = util.fs();
    var shell = fs.Shell();
    var contents = "a";
